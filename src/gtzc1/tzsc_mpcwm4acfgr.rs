#[doc = "Register `TZSC_MPCWM4ACFGR` reader"]
pub type R = crate::R<TZSC_MPCWM4ACFGR_SPEC>;
#[doc = "Register `TZSC_MPCWM4ACFGR` writer"]
pub type W = crate::W<TZSC_MPCWM4ACFGR_SPEC>;
...
impl W {
    #[doc = "Bit 0 - Sub-region z enable"]
    #[inline(always)]
    pub fn SREN(&mut self) -> SREN_W<'_, TZSC_MPCWM4ACFGR_SPEC> {
        SREN_W::new(self, 0)
    }
    #[doc = "Bit 1 - Sub-region z lock This bit, once set, can be cleared only by a system reset."]
    #[inline(always)]
    pub fn SRLOCK(&mut self) -> SRLOCK_W<'_, TZSC_MPCWM4ACFGR_SPEC> {
        SRLOCK_W::new(self, 1)
    }
    #[doc = "Bit 9 - Privileged sub-region z This bit is taken into account only if SREN is set."]
    #[inline(always)]
    pub fn PRIV(&mut self) -> PRIV_W<'_, TZSC_MPCWM4ACFGR_SPEC> {
        PRIV_W::new(self, 9)
    }
}
...
pub struct TZSC_MPCWM4ACFGR_SPEC;
impl crate::RegisterSpec for TZSC_MPCWM4ACFGR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tzsc_mpcwm4acfgr::R`](R) reader structure"]
impl crate::Readable for TZSC_MPCWM4ACFGR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`tzsc_mpcwm4acfgr::W`](W) writer structure"]
impl crate::Writable for TZSC_MPCWM4ACFGR_SPEC {
    type Safety = crate::Safe;
}
#[doc = "`reset()` method sets TZSC_MPCWM4ACFGR to value 0"]
impl crate::Resettable for TZSC_MPCWM4ACFGR_SPEC {}
