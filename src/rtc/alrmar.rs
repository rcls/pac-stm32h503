...
impl W {
    #[doc = "Bits 0:3 - Second units in BCD format."]
    #[inline(always)]
    pub fn SU(&mut self) -> SU_W<'_, ALRMAR_SPEC> {
        SU_W::new(self, 0)
    }
    #[doc = "Bits 4:6 - Second tens in BCD format."]
    #[inline(always)]
    pub fn ST(&mut self) -> ST_W<'_, ALRMAR_SPEC> {
        ST_W::new(self, 4)
    }
    #[doc = "Bit 7 - Alarm A seconds mask"]
    #[inline(always)]
    pub fn MSK1(&mut self) -> MSK1_W<'_, ALRMAR_SPEC> {
        MSK1_W::new(self, 7)
    }
    #[doc = "Bits 8:11 - Minute units in BCD format"]
    #[inline(always)]
    pub fn MNU(&mut self) -> MNU_W<'_, ALRMAR_SPEC> {
        MNU_W::new(self, 8)
    }
    #[doc = "Bits 12:14 - Minute tens in BCD format"]
    #[inline(always)]
    pub fn MNT(&mut self) -> MNT_W<'_, ALRMAR_SPEC> {
        MNT_W::new(self, 12)
    }
    #[doc = "Bit 15 - Alarm A minutes mask"]
    #[inline(always)]
    pub fn MSK2(&mut self) -> MSK2_W<'_, ALRMAR_SPEC> {
        MSK2_W::new(self, 15)
    }
    #[doc = "Bits 16:19 - Hour units in BCD format"]
    #[inline(always)]
    pub fn HU(&mut self) -> HU_W<'_, ALRMAR_SPEC> {
        HU_W::new(self, 16)
    }
    #[doc = "Bits 20:21 - Hour tens in BCD format"]
    #[inline(always)]
    pub fn HT(&mut self) -> HT_W<'_, ALRMAR_SPEC> {
        HT_W::new(self, 20)
    }
    #[doc = "Bit 22 - AM/PM notation"]
    #[inline(always)]
    pub fn PM(&mut self) -> PM_W<'_, ALRMAR_SPEC> {
        PM_W::new(self, 22)
    }
    #[doc = "Bit 23 - Alarm A hours mask"]
    #[inline(always)]
    pub fn MSK3(&mut self) -> MSK3_W<'_, ALRMAR_SPEC> {
        MSK3_W::new(self, 23)
    }
    #[doc = "Bits 24:27 - Date units or day in BCD format"]
    #[inline(always)]
    pub fn DU(&mut self) -> DU_W<'_, ALRMAR_SPEC> {
        DU_W::new(self, 24)
    }
    #[doc = "Bits 28:29 - Date tens in BCD format"]
    #[inline(always)]
    pub fn DT(&mut self) -> DT_W<'_, ALRMAR_SPEC> {
        DT_W::new(self, 28)
    }
    #[doc = "Bit 30 - Week day selection"]
    #[inline(always)]
    pub fn WDSEL(&mut self) -> WDSEL_W<'_, ALRMAR_SPEC> {
        WDSEL_W::new(self, 30)
    }
    #[doc = "Bit 31 - Alarm A date mask"]
    #[inline(always)]
    pub fn MSK4(&mut self) -> MSK4_W<'_, ALRMAR_SPEC> {
        MSK4_W::new(self, 31)
    }
}
