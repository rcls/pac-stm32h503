...
#[doc = "Field `SS` writer - Subseconds value This value is compared with the contents of the synchronous prescaler counter to determine if alarm B is to be activated. Only bits 0 up to MASKSS-1 are compared. This field is the mirror of SS\\[14:0\\] in the RTC_ALRMBBINR, and so can also be read or written through RTC_ALRMBBINR."]
...
pub enum MASKSS_A {
    ...
    B_0x0 = 0,
    #[doc = "1: SS\\[31:1\\] are don't care in Alarm B comparison. Only SS\\[0\\] is compared."]
    B_0x1 = 1,
}
...
impl MASKSS_R {
    ...
    #[doc = "SS\\[31:1\\] are don't care in Alarm B comparison. Only SS\\[0\\] is compared."]
    #[inline(always)]
...
pub enum SSCLR_A {
    ...
    B_0x0 = 0,
    #[doc = "1: The synchronous binary counter (SS\\[31:0\\] in RTC_SSR) is running from 0xFFFF FFFF to RTC_ALRMBBINR.SS\\[31:0\\] value and is automatically reloaded with 0xFFFF FFFF one ck_apre cycle after reaching RTC_ALRMBBINR.SS\\[31:0\\]."]
    B_0x1 = 1,
}
...
impl SSCLR_R {
    ...
    #[doc = "The synchronous binary counter (SS\\[31:0\\] in RTC_SSR) is running from 0xFFFF FFFF to RTC_ALRMBBINR.SS\\[31:0\\] value and is automatically reloaded with 0xFFFF FFFF one ck_apre cycle after reaching RTC_ALRMBBINR.SS\\[31:0\\]."]
    #[inline(always)]
    pub fn is_B_0x1(&self) -> bool {
        *self == SSCLR_A::B_0x1
    }
...
impl W {
    ...
    #[doc = "Bit 31 - Clear synchronous counter on alarm (Binary mode only) Note: SSCLR must be kept to 0 when BCD or mixed mode is used (BIN = 00, 10 or 11)."]
    #[inline(always)]
    pub fn SSCLR(&mut self) -> SSCLR_W<'_, ALRMBSSR_SPEC> {
        SSCLR_W::new(self, 31)
    }
}
