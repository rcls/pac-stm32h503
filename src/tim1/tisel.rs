...
#[doc = "Selects tim_ti1\\[0..15\\] input ... Refer to Section 65.3.2: TIM1 pins and internal signals for interconnects list.\n\nValue on reset: 0"]
...
#[doc = "Field `TI1SEL` reader - Selects tim_ti1\\[0..15\\] input ... Refer to Section 65.3.2: TIM1 pins and internal signals for interconnects list."]
...
#[doc = "Field `TI1SEL` writer - Selects tim_ti1\\[0..15\\] input ... Refer to Section 65.3.2: TIM1 pins and internal signals for interconnects list."]
...
#[doc = "Selects tim_ti2\\[0..15\\] input ... Refer to Section 65.3.2: TIM1 pins and internal signals for interconnects list.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum TI2SEL_A {
...
#[doc = "Field `TI2SEL` reader - Selects tim_ti2\\[0..15\\] input ... Refer to Section 65.3.2: TIM1 pins and internal signals for interconnects list."]
...
#[doc = "Field `TI2SEL` writer - Selects tim_ti2\\[0..15\\] input ... Refer to Section 65.3.2: TIM1 pins and internal signals for interconnects list."]
...
#[doc = "Selects tim_ti3\\[0..15\\] input ... Refer to Section 65.3.2: TIM1 pins and internal signals for interconnects list.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum TI3SEL_A {
    #[doc = "0: tim_ti3_in0: TIMx_CH2"]
    B_0x0 = 0,
    #[doc = "1: tim_ti3_in1"]
    B_0x1 = 1,
    #[doc = "15: tim_ti3_in15"]
...
#[doc = "Field `TI3SEL` reader - Selects tim_ti3\\[0..15\\] input ... Refer to Section 65.3.2: TIM1 pins and internal signals for interconnects list."]
...
#[doc = "Field `TI3SEL` writer - Selects tim_ti3\\[0..15\\] input ... Refer to Section 65.3.2: TIM1 pins and internal signals for interconnects list."]
...
#[doc = "Selects tim_ti4\\[0..15\\] input ... Refer to Section 65.3.2: TIM1 pins and internal signals for interconnects list.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum TI4SEL_A {
...
#[doc = "Field `TI4SEL` reader - Selects tim_ti4\\[0..15\\] input ... Refer to Section 65.3.2: TIM1 pins and internal signals for interconnects list."]
...
#[doc = "Field `TI4SEL` writer - Selects tim_ti4\\[0..15\\] input ... Refer to Section 65.3.2: TIM1 pins and internal signals for interconnects list."]
...
impl R {
    #[doc = "Bits 0:3 - Selects tim_ti1\\[0..15\\] input ... Refer to Section 65.3.2: TIM1 pins and internal signals for interconnects list."]
    #[inline(always)]
    pub fn TI1SEL(&self) -> TI1SEL_R {
        TI1SEL_R::new((self.bits & 0x0f) as u8)
    }
    #[doc = "Bits 8:11 - Selects tim_ti2\\[0..15\\] input ... Refer to Section 65.3.2: TIM1 pins and internal signals for interconnects list."]
    #[inline(always)]
    pub fn TI2SEL(&self) -> TI2SEL_R {
        TI2SEL_R::new(((self.bits >> 8) & 0x0f) as u8)
    }
    #[doc = "Bits 16:19 - Selects tim_ti3\\[0..15\\] input ... Refer to Section 65.3.2: TIM1 pins and internal signals for interconnects list."]
    #[inline(always)]
    pub fn TI3SEL(&self) -> TI3SEL_R {
        TI3SEL_R::new(((self.bits >> 16) & 0x0f) as u8)
    }
    #[doc = "Bits 24:27 - Selects tim_ti4\\[0..15\\] input ... Refer to Section 65.3.2: TIM1 pins and internal signals for interconnects list."]
    #[inline(always)]
