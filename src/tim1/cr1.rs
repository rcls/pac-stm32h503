...
#[doc = "Clock division This bit-field indicates the division ratio between the timer clock (tim_ker_ck) frequency and the dead-time and sampling clock (t DTS )used by the dead-time generators and the digital filters (tim_etr_in, tim_tix),\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum CKD_A {
    #[doc = "0: t DTS =t tim_ker_ck"]
    B_0x0 = 0,
    #[doc = "1: t DTS =2*t tim_ker_ck"]
    B_0x1 = 1,
    #[doc = "2: t DTS =4*t tim_ker_ck"]
    B_0x2 = 2,
...
#[doc = "Field `CKD` reader - Clock division This bit-field indicates the division ratio between the timer clock (tim_ker_ck) frequency and the dead-time and sampling clock (t DTS )used by the dead-time generators and the digital filters (tim_etr_in, tim_tix),"]
...
impl CKD_R {
    ...
    #[doc = "t DTS =t tim_ker_ck"]
    #[inline(always)]
    pub fn is_B_0x0(&self) -> bool {
        *self == CKD_A::B_0x0
    }
    #[doc = "t DTS =2*t tim_ker_ck"]
    #[inline(always)]
    pub fn is_B_0x1(&self) -> bool {
        *self == CKD_A::B_0x1
    }
    #[doc = "t DTS =4*t tim_ker_ck"]
    #[inline(always)]
    pub fn is_B_0x2(&self) -> bool {
        *self == CKD_A::B_0x2
    }
...
#[doc = "Field `CKD` writer - Clock division This bit-field indicates the division ratio between the timer clock (tim_ker_ck) frequency and the dead-time and sampling clock (t DTS )used by the dead-time generators and the digital filters (tim_etr_in, tim_tix),"]
pub type CKD_W<'a, REG> = crate::FieldWriter<'a, REG, 2, CKD_A, crate::Safe>;
...
impl R {
    ...
    #[doc = "Bits 8:9 - Clock division This bit-field indicates the division ratio between the timer clock (tim_ker_ck) frequency and the dead-time and sampling clock (t DTS )used by the dead-time generators and the digital filters (tim_etr_in, tim_tix),"]
    #[inline(always)]
