...
#[doc = "Field `PW` reader - Pulse width This bitfield defines the pulse duration, as following: t PW = PW\\[7:0\\] x t PWG"]
pub type PW_R = crate::FieldReader;
#[doc = "Field `PW` writer - Pulse width This bitfield defines the pulse duration, as following: t PW = PW\\[7:0\\] x t PWG"]
pub type PW_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `PWPRSC` reader - Pulse width prescaler This bitfield sets the clock prescaler for the pulse generator, as following: t PWG = (2sup(PWPRSC\\[2:0\\])/sup) x t tim_ker_ck"]
pub type PWPRSC_R = crate::FieldReader;
#[doc = "Field `PWPRSC` writer - Pulse width prescaler This bitfield sets the clock prescaler for the pulse generator, as following: t PWG = (2sup(PWPRSC\\[2:0\\])/sup) x t tim_ker_ck"]
...
impl R {
    ...
    #[doc = "Bits 16:23 - Pulse width This bitfield defines the pulse duration, as following: t PW = PW\\[7:0\\] x t PWG"]
    #[inline(always)]
    pub fn PW(&self) -> PW_R {
        PW_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    #[doc = "Bits 24:26 - Pulse width prescaler This bitfield sets the clock prescaler for the pulse generator, as following: t PWG = (2sup(PWPRSC\\[2:0\\])/sup) x t tim_ker_ck"]
    #[inline(always)]
