...
impl OC1M_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> OC1M_A {
        match self.bits {
            0 => OC1M_A::B_0x0,
            1 => OC1M_A::B_0x1,
            2 => OC1M_A::B_0x2,
...
pub type OC1M_W<'a, REG> = crate::FieldWriter<'a, REG, 3, OC1M_A, crate::Safe>;
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn B_0x0(self) -> &'a mut crate::W<REG> {
        self.variant(OC1M_A::B_0x0)
    }
    #[doc = "Set channel 1 to active level on match. tim_oc1ref signal is forced high when the counter TIMx_CNT matches the capture/compare register 1 (TIMx_CCR1)."]
    #[inline(always)]
    pub fn B_0x1(self) -> &'a mut crate::W<REG> {
        self.variant(OC1M_A::B_0x1)
    }
    #[doc = "Set channel 1 to inactive level on match. tim_oc1ref signal is forced low when the counter TIMx_CNT matches the capture/compare register 1 (TIMx_CCR1)."]
    #[inline(always)]
    pub fn B_0x2(self) -> &'a mut crate::W<REG> {
        self.variant(OC1M_A::B_0x2)
    }
    #[doc = "Toggle - tim_oc1ref toggles when TIMx_CNT=TIMx_CCR1."]
    #[inline(always)]
    pub fn B_0x3(self) -> &'a mut crate::W<REG> {
        self.variant(OC1M_A::B_0x3)
    }
    #[doc = "Force inactive level - tim_oc1ref is forced low."]
    #[inline(always)]
    pub fn B_0x4(self) -> &'a mut crate::W<REG> {
        self.variant(OC1M_A::B_0x4)
    }
    #[doc = "Force active level - tim_oc1ref is forced high."]
    #[inline(always)]
    pub fn B_0x5(self) -> &'a mut crate::W<REG> {
        self.variant(OC1M_A::B_0x5)
    }
    #[doc = "PWM mode 1 - In upcounting, channel 1 is active as long as TIMx_CNTTIMx_CCR1 else inactive. In downcounting, channel 1 is inactive (tim_oc1ref='0') as long as TIMx_CNTTIMx_CCR1 else active (tim_oc1ref='1')."]
    #[inline(always)]
    pub fn B_0x6(self) -> &'a mut crate::W<REG> {
        self.variant(OC1M_A::B_0x6)
    }
    #[doc = "PWM mode 2 - In upcounting, channel 1 is inactive as long as TIMx_CNTTIMx_CCR1 else active. In downcounting, channel 1 is active as long as TIMx_CNTTIMx_CCR1 else inactive."]
    #[inline(always)]
    pub fn B_0x7(self) -> &'a mut crate::W<REG> {
        self.variant(OC1M_A::B_0x7)
    }
}
#[doc = "Output compare 1 clear enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum OC1CE_A {
    #[doc = "0: tim_oc1ref is not affected by the tim_ocref_clr_int signal"]
    B_0x0 = 0,
    #[doc = "1: tim_oc1ref is cleared as soon as a High level is detected on tim_ocref_clr_int signal (tim_ocref_clr input or tim_etrf input)"]
    B_0x1 = 1,
}
...
impl OC1CE_R {
    ...
    #[doc = "tim_oc1ref is not affected by the tim_ocref_clr_int signal"]
    #[inline(always)]
    pub fn is_B_0x0(&self) -> bool {
        *self == OC1CE_A::B_0x0
    }
    #[doc = "tim_oc1ref is cleared as soon as a High level is detected on tim_ocref_clr_int signal (tim_ocref_clr input or tim_etrf input)"]
    #[inline(always)]
    pub fn is_B_0x1(&self) -> bool {
        *self == OC1CE_A::B_0x1
    }
...
impl W {
    ...
    #[doc = "Bits 12:14 - OC2M\\[2:0\\]: Output compare 2 mode"]
    #[inline(always)]
    pub fn OC2M(&mut self) -> OC2M_W<'_, CCMR1_OUTPUT_SPEC> {
        OC2M_W::new(self, 12)
    }
    #[doc = "Bit 15 - Output compare 2 clear enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 16 - OC1M\\[3\\]"]
    #[inline(always)]
    pub fn OC1M_1(&mut self) -> OC1M_1_W<'_, CCMR1_OUTPUT_SPEC> {
        OC1M_1_W::new(self, 16)
    }
    #[doc = "Bit 24 - OC2M\\[3\\]"]
    #[inline(always)]
    pub fn OC2M_1(&mut self) -> OC2M_1_W<'_, CCMR1_OUTPUT_SPEC> {
