...
#[doc = "Privilege enable on event input 19\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PRIV19_A {
    #[doc = "0: Event privilege disabled (unprivileged)"]
    B_0x0 = 0,
...
#[doc = "Privilege enable on event input x (x = 22 to 21)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PRIV21_A {
    #[doc = "0: Event privilege disabled (unprivileged)"]
    B_0x0 = 0,
...
#[doc = "Privilege enable on event input x (x = 29 to 24)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PRIV24_A {
    #[doc = "0: Event privilege disabled (unprivileged)"]
    B_0x0 = 0,
...
impl W {
    #[doc = "Bit 0 - Privilege enable on event input x (x = 17 to 0)"]
    #[inline(always)]
    pub fn PRIV0(&mut self) -> PRIV0_W<'_, PRIVCFGR1_SPEC> {
        PRIV0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Privilege enable on event input x (x = 17 to 0)"]
    #[inline(always)]
    pub fn PRIV1(&mut self) -> PRIV1_W<'_, PRIVCFGR1_SPEC> {
        PRIV1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Privilege enable on event input x (x = 17 to 0)"]
    #[inline(always)]
    pub fn PRIV2(&mut self) -> PRIV2_W<'_, PRIVCFGR1_SPEC> {
        PRIV2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Privilege enable on event input x (x = 17 to 0)"]
    #[inline(always)]
    pub fn PRIV3(&mut self) -> PRIV3_W<'_, PRIVCFGR1_SPEC> {
        PRIV3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Privilege enable on event input x (x = 17 to 0)"]
    #[inline(always)]
    pub fn PRIV4(&mut self) -> PRIV4_W<'_, PRIVCFGR1_SPEC> {
        PRIV4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Privilege enable on event input x (x = 17 to 0)"]
    #[inline(always)]
    pub fn PRIV5(&mut self) -> PRIV5_W<'_, PRIVCFGR1_SPEC> {
        PRIV5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Privilege enable on event input x (x = 17 to 0)"]
    #[inline(always)]
    pub fn PRIV6(&mut self) -> PRIV6_W<'_, PRIVCFGR1_SPEC> {
        PRIV6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Privilege enable on event input x (x = 17 to 0)"]
    #[inline(always)]
    pub fn PRIV7(&mut self) -> PRIV7_W<'_, PRIVCFGR1_SPEC> {
        PRIV7_W::new(self, 7)
    }
    #[doc = "Bit 8 - Privilege enable on event input x (x = 17 to 0)"]
    #[inline(always)]
    pub fn PRIV8(&mut self) -> PRIV8_W<'_, PRIVCFGR1_SPEC> {
        PRIV8_W::new(self, 8)
    }
    #[doc = "Bit 9 - Privilege enable on event input x (x = 17 to 0)"]
    #[inline(always)]
    pub fn PRIV9(&mut self) -> PRIV9_W<'_, PRIVCFGR1_SPEC> {
        PRIV9_W::new(self, 9)
    }
    #[doc = "Bit 10 - Privilege enable on event input x (x = 17 to 0)"]
    #[inline(always)]
    pub fn PRIV10(&mut self) -> PRIV10_W<'_, PRIVCFGR1_SPEC> {
        PRIV10_W::new(self, 10)
    }
    #[doc = "Bit 11 - Privilege enable on event input x (x = 17 to 0)"]
    #[inline(always)]
    pub fn PRIV11(&mut self) -> PRIV11_W<'_, PRIVCFGR1_SPEC> {
        PRIV11_W::new(self, 11)
    }
    #[doc = "Bit 12 - Privilege enable on event input x (x = 17 to 0)"]
    #[inline(always)]
    pub fn PRIV12(&mut self) -> PRIV12_W<'_, PRIVCFGR1_SPEC> {
        PRIV12_W::new(self, 12)
    }
    #[doc = "Bit 13 - Privilege enable on event input x (x = 17 to 0)"]
    #[inline(always)]
    pub fn PRIV13(&mut self) -> PRIV13_W<'_, PRIVCFGR1_SPEC> {
        PRIV13_W::new(self, 13)
    }
    #[doc = "Bit 14 - Privilege enable on event input x (x = 17 to 0)"]
    #[inline(always)]
    pub fn PRIV14(&mut self) -> PRIV14_W<'_, PRIVCFGR1_SPEC> {
        PRIV14_W::new(self, 14)
    }
    #[doc = "Bit 15 - Privilege enable on event input x (x = 17 to 0)"]
    #[inline(always)]
    pub fn PRIV15(&mut self) -> PRIV15_W<'_, PRIVCFGR1_SPEC> {
        PRIV15_W::new(self, 15)
    }
    #[doc = "Bit 16 - Privilege enable on event input x (x = 17 to 0)"]
    #[inline(always)]
    pub fn PRIV16(&mut self) -> PRIV16_W<'_, PRIVCFGR1_SPEC> {
        PRIV16_W::new(self, 16)
    }
    #[doc = "Bit 17 - Privilege enable on event input x (x = 17 to 0)"]
    #[inline(always)]
    pub fn PRIV17(&mut self) -> PRIV17_W<'_, PRIVCFGR1_SPEC> {
        PRIV17_W::new(self, 17)
    }
    #[doc = "Bit 19 - Privilege enable on event input 19"]
    #[inline(always)]
    pub fn PRIV19(&mut self) -> PRIV19_W<'_, PRIVCFGR1_SPEC> {
        PRIV19_W::new(self, 19)
    }
    #[doc = "Bit 21 - Privilege enable on event input x (x = 22 to 21)"]
    #[inline(always)]
    pub fn PRIV21(&mut self) -> PRIV21_W<'_, PRIVCFGR1_SPEC> {
        PRIV21_W::new(self, 21)
    }
    #[doc = "Bit 22 - Privilege enable on event input x (x = 22 to 21)"]
    #[inline(always)]
    pub fn PRIV22(&mut self) -> PRIV22_W<'_, PRIVCFGR1_SPEC> {
        PRIV22_W::new(self, 22)
    }
    #[doc = "Bit 24 - Privilege enable on event input x (x = 29 to 24)"]
    #[inline(always)]
    pub fn PRIV24(&mut self) -> PRIV24_W<'_, PRIVCFGR1_SPEC> {
        PRIV24_W::new(self, 24)
    }
    #[doc = "Bit 25 - Privilege enable on event input x (x = 29 to 24)"]
    #[inline(always)]
    pub fn PRIV25(&mut self) -> PRIV25_W<'_, PRIVCFGR1_SPEC> {
        PRIV25_W::new(self, 25)
    }
    #[doc = "Bit 26 - Privilege enable on event input x (x = 29 to 24)"]
    #[inline(always)]
    pub fn PRIV26(&mut self) -> PRIV26_W<'_, PRIVCFGR1_SPEC> {
        PRIV26_W::new(self, 26)
    }
    #[doc = "Bit 27 - Privilege enable on event input x (x = 29 to 24)"]
    #[inline(always)]
    pub fn PRIV27(&mut self) -> PRIV27_W<'_, PRIVCFGR1_SPEC> {
        PRIV27_W::new(self, 27)
    }
    #[doc = "Bit 28 - Privilege enable on event input x (x = 29 to 24)"]
    #[inline(always)]
    pub fn PRIV28(&mut self) -> PRIV28_W<'_, PRIVCFGR1_SPEC> {
        PRIV28_W::new(self, 28)
    }
    #[doc = "Bit 29 - Privilege enable on event input x (x = 29 to 24)"]
    #[inline(always)]
    pub fn PRIV29(&mut self) -> PRIV29_W<'_, PRIVCFGR1_SPEC> {
