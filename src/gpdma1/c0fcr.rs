...
impl W {
    ...
    #[inline(always)]
    pub fn TCF(&mut self) -> TCF_W<'_, C0FCR_SPEC> {
        TCF_W::new(self, 8)
    }
    #[doc = "Bit 9 - half transfer flag clear"]
    #[inline(always)]
    pub fn HTF(&mut self) -> HTF_W<'_, C0FCR_SPEC> {
        HTF_W::new(self, 9)
    }
    #[doc = "Bit 10 - data transfer error flag clear"]
    #[inline(always)]
    pub fn DTEF(&mut self) -> DTEF_W<'_, C0FCR_SPEC> {
        DTEF_W::new(self, 10)
    }
    #[doc = "Bit 11 - update link transfer error flag clear"]
    #[inline(always)]
    pub fn ULEF(&mut self) -> ULEF_W<'_, C0FCR_SPEC> {
        ULEF_W::new(self, 11)
    }
    #[doc = "Bit 12 - user setting error flag clear"]
    #[inline(always)]
    pub fn USEF(&mut self) -> USEF_W<'_, C0FCR_SPEC> {
        USEF_W::new(self, 12)
    }
    #[doc = "Bit 13 - completed suspension flag clear"]
    #[inline(always)]
    pub fn SUSPF(&mut self) -> SUSPF_W<'_, C0FCR_SPEC> {
        SUSPF_W::new(self, 13)
    }
    #[doc = "Bit 14 - trigger overrun flag clear"]
    #[inline(always)]
    pub fn TOF(&mut self) -> TOF_W<'_, C0FCR_SPEC> {
        TOF_W::new(self, 14)
    }
}
