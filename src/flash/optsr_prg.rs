...
#[doc = "Brownout level option configuration bit These bits reflects the power level that generates a system reset.\n\nValue on reset: 0"]
...
pub type BOR_LEV_W<'a, REG> = crate::FieldWriter<'a, REG, 2, BOR_LEV_A, crate::Safe>;
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn B_0x0(self) -> &'a mut crate::W<REG> {
        self.variant(BOR_LEV_A::B_0x0)
    }
    #[doc = "BOR Level 1, the threshold level is low (around 2.1 V)"]
    #[inline(always)]
    pub fn B_0x1(self) -> &'a mut crate::W<REG> {
        self.variant(BOR_LEV_A::B_0x1)
    }
    #[doc = "BOR Level 2, the threshold level is medium (around 2.4 V)"]
    #[inline(always)]
    pub fn B_0x2(self) -> &'a mut crate::W<REG> {
        self.variant(BOR_LEV_A::B_0x2)
    }
    #[doc = "BOR Level 3, the threshold level is high (around 2.7 V)"]
    #[inline(always)]
    pub fn B_0x3(self) -> &'a mut crate::W<REG> {
        self.variant(BOR_LEV_A::B_0x3)
    }
}
#[doc = "Brownout high enable configuration bit\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BORH_EN_A {
    #[doc = "0: disabled"]
    B_0x0 = 0,
...
pub type BORH_EN_W<'a, REG> = crate::BitWriter<'a, REG, BORH_EN_A>;
impl<'a, REG> BORH_EN_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "disabled"]
    #[inline(always)]
    pub fn B_0x0(self) -> &'a mut crate::W<REG> {
        self.variant(BORH_EN_A::B_0x0)
    }
    #[doc = "enabled"]
    #[inline(always)]
    pub fn B_0x1(self) -> &'a mut crate::W<REG> {
        self.variant(BORH_EN_A::B_0x1)
    }
}
...
pub type IWDG_SW_W<'a, REG> = crate::BitWriter<'a, REG, IWDG_SW_A>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn B_0x0(self) -> &'a mut crate::W<REG> {
        self.variant(IWDG_SW_A::B_0x0)
    }
    #[doc = "IWDG watchdog is controlled by software"]
    #[inline(always)]
    pub fn B_0x1(self) -> &'a mut crate::W<REG> {
        self.variant(IWDG_SW_A::B_0x1)
    }
}
...
pub type WWDG_SW_W<'a, REG> = crate::BitWriter<'a, REG, WWDG_SW_A>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn B_0x0(self) -> &'a mut crate::W<REG> {
        self.variant(WWDG_SW_A::B_0x0)
    }
    #[doc = "WWDG watchdog is controlled by software"]
    #[inline(always)]
    pub fn B_0x1(self) -> &'a mut crate::W<REG> {
        self.variant(WWDG_SW_A::B_0x1)
    }
}
#[doc = "Core domain Shutdown entry reset option configuration bit\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
pub type NRST_SHDW_W<'a, REG> = crate::BitWriter<'a, REG, NRST_SHDW_A>;
impl<'a, REG> NRST_SHDW_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "a reset is generated when entering Shutdown mode on core domain"]
    #[inline(always)]
    pub fn B_0x0(self) -> &'a mut crate::W<REG> {
        self.variant(NRST_SHDW_A::B_0x0)
    }
    #[doc = "no reset generated when entering Shutdown mode on core domain."]
    #[inline(always)]
    pub fn B_0x1(self) -> &'a mut crate::W<REG> {
        self.variant(NRST_SHDW_A::B_0x1)
    }
}
...
pub type NRST_STOP_W<'a, REG> = crate::BitWriter<'a, REG, NRST_STOP_A>;
impl<'a, REG> NRST_STOP_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "a reset is generated when entering Stop mode on core domain"]
    #[inline(always)]
    pub fn B_0x0(self) -> &'a mut crate::W<REG> {
        self.variant(NRST_STOP_A::B_0x0)
    }
    #[doc = "no reset generated when entering Stop mode on core domain."]
    #[inline(always)]
    pub fn B_0x1(self) -> &'a mut crate::W<REG> {
        self.variant(NRST_STOP_A::B_0x1)
    }
}
...
pub type NRST_STDBY_W<'a, REG> = crate::BitWriter<'a, REG, NRST_STDBY_A>;
impl<'a, REG> NRST_STDBY_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "a reset is generated when entering Standby mode on core domain"]
    #[inline(always)]
    pub fn B_0x0(self) -> &'a mut crate::W<REG> {
        self.variant(NRST_STDBY_A::B_0x0)
    }
    #[doc = "no reset generated when entering Standby mode on core domain."]
    #[inline(always)]
    pub fn B_0x1(self) -> &'a mut crate::W<REG> {
        self.variant(NRST_STDBY_A::B_0x1)
    }
}
...
#[doc = "High-speed IO at low VDD voltage configuration bit. This bit can be set only with VDD below 2.5 V.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
pub type IO_VDD_HSLV_W<'a, REG> = crate::BitWriter<'a, REG, IO_VDD_HSLV_A>;
impl<'a, REG> IO_VDD_HSLV_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "High-speed IO at low VDD voltage feature disabled (VDD can exceed 2.5 V)"]
    #[inline(always)]
    pub fn B_0x0(self) -> &'a mut crate::W<REG> {
        self.variant(IO_VDD_HSLV_A::B_0x0)
    }
    #[doc = "High-speed IO at low VDD voltage feature enabled (VDD remains below 2.5 V)"]
    #[inline(always)]
    pub fn B_0x1(self) -> &'a mut crate::W<REG> {
        self.variant(IO_VDD_HSLV_A::B_0x1)
    }
}
...
pub type IO_VDDIO2_HSLV_W<'a, REG> = crate::BitWriter<'a, REG, IO_VDDIO2_HSLV_A>;
impl<'a, REG> IO_VDDIO2_HSLV_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "High-speed IO at low VDDIO2 voltage feature disabled (VDDIO2 can exceed 2.5 V)"]
    #[inline(always)]
    pub fn B_0x0(self) -> &'a mut crate::W<REG> {
        self.variant(IO_VDDIO2_HSLV_A::B_0x0)
    }
    #[doc = "High-speed IO at low VDDIO2 voltage feature enabled (VDDIO2 remains below 2.5 V)"]
    #[inline(always)]
    pub fn B_0x1(self) -> &'a mut crate::W<REG> {
        self.variant(IO_VDDIO2_HSLV_A::B_0x1)
    }
}
#[doc = "IWDG Stop mode freeze option configuration bit When set the independent watchdog IWDG is in system Stop mode.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
pub type IWDG_STOP_W<'a, REG> = crate::BitWriter<'a, REG, IWDG_STOP_A>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn B_0x0(self) -> &'a mut crate::W<REG> {
        self.variant(IWDG_STOP_A::B_0x0)
    }
    #[doc = "Independent watchdog keep running in system Stop mode."]
    #[inline(always)]
    pub fn B_0x1(self) -> &'a mut crate::W<REG> {
        self.variant(IWDG_STOP_A::B_0x1)
    }
}
#[doc = "IWDG Standby mode freeze option configuration bit When set the independent watchdog IWDG is frozen in system Standby mode.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
pub type IWDG_STDBY_W<'a, REG> = crate::BitWriter<'a, REG, IWDG_STDBY_A>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn B_0x0(self) -> &'a mut crate::W<REG> {
        self.variant(IWDG_STDBY_A::B_0x0)
    }
    #[doc = "Independent watchdog keep running in Standby mode."]
    #[inline(always)]
    pub fn B_0x1(self) -> &'a mut crate::W<REG> {
        self.variant(IWDG_STDBY_A::B_0x1)
    }
}
#[doc = "Bank swapping option configuration bit SWAP_BANK option bit is used to configure whether the Bank1 and Bank2 are swapped or not. This bit is loaded with the SWAP_BANK bit of FLASH_OPTSR_CUR register after a reset.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
pub type SWAP_BANK_W<'a, REG> = crate::BitWriter<'a, REG, SWAP_BANK_A>;
impl<'a, REG> SWAP_BANK_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Bank1 and Bank2 not swapped"]
    #[inline(always)]
    pub fn B_0x0(self) -> &'a mut crate::W<REG> {
        self.variant(SWAP_BANK_A::B_0x0)
    }
    #[doc = "Bank1 and Bank2 swapped"]
    #[inline(always)]
    pub fn B_0x1(self) -> &'a mut crate::W<REG> {
        self.variant(SWAP_BANK_A::B_0x1)
    }
}
impl R {
...
impl W {
    #[doc = "Bits 0:1 - Brownout level option configuration bit These bits reflects the power level that generates a system reset."]
    #[inline(always)]
    pub fn BOR_LEV(&mut self) -> BOR_LEV_W<'_, OPTSR_PRG_SPEC> {
        BOR_LEV_W::new(self, 0)
    }
    #[doc = "Bit 2 - Brownout high enable configuration bit"]
    #[inline(always)]
    pub fn BORH_EN(&mut self) -> BORH_EN_W<'_, OPTSR_PRG_SPEC> {
        BORH_EN_W::new(self, 2)
    }
    #[doc = "Bit 3 - IWDG control mode option configuration bit"]
    #[inline(always)]
    pub fn IWDG_SW(&mut self) -> IWDG_SW_W<'_, OPTSR_PRG_SPEC> {
        IWDG_SW_W::new(self, 3)
    }
    #[doc = "Bit 4 - WWDG control mode option configuration bit"]
    #[inline(always)]
    pub fn WWDG_SW(&mut self) -> WWDG_SW_W<'_, OPTSR_PRG_SPEC> {
        WWDG_SW_W::new(self, 4)
    }
    #[doc = "Bit 5 - Core domain Shutdown entry reset option configuration bit"]
    #[inline(always)]
    pub fn NRST_SHDW(&mut self) -> NRST_SHDW_W<'_, OPTSR_PRG_SPEC> {
        NRST_SHDW_W::new(self, 5)
    }
    #[doc = "Bit 6 - Core domain Stop entry reset option configuration bit"]
    #[inline(always)]
    pub fn NRST_STOP(&mut self) -> NRST_STOP_W<'_, OPTSR_PRG_SPEC> {
        NRST_STOP_W::new(self, 6)
    }
    #[doc = "Bit 7 - Core domain Standby entry reset option configuration bit"]
    #[inline(always)]
    pub fn NRST_STDBY(&mut self) -> NRST_STDBY_W<'_, OPTSR_PRG_SPEC> {
        NRST_STDBY_W::new(self, 7)
    }
    #[doc = "Bits 8:15 - Life state code (based on Hamming 8,4). More information in ."]
    #[inline(always)]
    pub fn PRODUCT_STATE(&mut self) -> PRODUCT_STATE_W<'_, OPTSR_PRG_SPEC> {
        PRODUCT_STATE_W::new(self, 8)
    }
    #[doc = "Bit 16 - High-speed IO at low VDD voltage configuration bit. This bit can be set only with VDD below 2.5 V."]
    #[inline(always)]
    pub fn IO_VDD_HSLV(&mut self) -> IO_VDD_HSLV_W<'_, OPTSR_PRG_SPEC> {
        IO_VDD_HSLV_W::new(self, 16)
    }
    #[doc = "Bit 17 - High-speed IO at low VDDIO2 voltage configuration bit. This bit can be set only with VDDIO2 below 2.5 V."]
    #[inline(always)]
    pub fn IO_VDDIO2_HSLV(&mut self) -> IO_VDDIO2_HSLV_W<'_, OPTSR_PRG_SPEC> {
        IO_VDDIO2_HSLV_W::new(self, 17)
    }
    #[doc = "Bit 20 - IWDG Stop mode freeze option configuration bit When set the independent watchdog IWDG is in system Stop mode."]
    #[inline(always)]
    pub fn IWDG_STOP(&mut self) -> IWDG_STOP_W<'_, OPTSR_PRG_SPEC> {
        IWDG_STOP_W::new(self, 20)
    }
    #[doc = "Bit 21 - IWDG Standby mode freeze option configuration bit When set the independent watchdog IWDG is frozen in system Standby mode."]
    #[inline(always)]
    pub fn IWDG_STDBY(&mut self) -> IWDG_STDBY_W<'_, OPTSR_PRG_SPEC> {
        IWDG_STDBY_W::new(self, 21)
    }
    #[doc = "Bit 31 - Bank swapping option configuration bit SWAP_BANK option bit is used to configure whether the Bank1 and Bank2 are swapped or not. This bit is loaded with the SWAP_BANK bit of FLASH_OPTSR_CUR register after a reset."]
    #[inline(always)]
    pub fn SWAP_BANK(&mut self) -> SWAP_BANK_W<'_, OPTSR_PRG_SPEC> {
