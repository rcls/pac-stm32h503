#[doc = "Register `5DEAR` reader"]
pub type R = crate::R<_5DEAR_SPEC>;
...
#[doc = "RAMCFG memory 5 ECC double error address register\n\nYou can [`read`](crate::Reg::read) this register and get [`_5dear::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct _5DEAR_SPEC;
impl crate::RegisterSpec for _5DEAR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`_5dear::R`](R) reader structure"]
impl crate::Readable for _5DEAR_SPEC {}
#[doc = "`reset()` method sets 5DEAR to value 0"]
impl crate::Resettable for _5DEAR_SPEC {}
