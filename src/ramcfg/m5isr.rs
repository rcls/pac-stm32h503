...
pub struct M5ISR_SPEC;
impl crate::RegisterSpec for M5ISR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`m5isr::R`](R) reader structure"]
impl crate::Readable for M5ISR_SPEC {}
#[doc = "`reset()` method sets M5ISR to value 0"]
impl crate::Resettable for M5ISR_SPEC {}
