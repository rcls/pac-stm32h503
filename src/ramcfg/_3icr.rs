#[doc = "Register `3ICR` reader"]
pub type R = crate::R<_3ICR_SPEC>;
#[doc = "Register `3ICR` writer"]
pub type W = crate::W<_3ICR_SPEC>;
...
impl W {
    #[doc = "Bit 0 - Clear ECC single error detected and corrected Writing 1 to this flag clears the SEDC bit in the RAMCFG_MxISR register. Reading this flag returns the SEDC value."]
    #[inline(always)]
    pub fn CSEDC(&mut self) -> CSEDC_W<'_, _3ICR_SPEC> {
        CSEDC_W::new(self, 0)
    }
    #[doc = "Bit 1 - Clear ECC double error detected Writing 1 to this flag clears the DED bit in the RAMCFG_MxISR register. Reading this flag returns the DED value."]
    #[inline(always)]
    pub fn CDED(&mut self) -> CDED_W<'_, _3ICR_SPEC> {
        CDED_W::new(self, 1)
    }
}
#[doc = "RAMCFG memory 3 interrupt clear register 3\n\nYou can [`read`](crate::Reg::read) this register and get [`_3icr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`_3icr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct _3ICR_SPEC;
impl crate::RegisterSpec for _3ICR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`_3icr::R`](R) reader structure"]
impl crate::Readable for _3ICR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`_3icr::W`](W) writer structure"]
impl crate::Writable for _3ICR_SPEC {
    type Safety = crate::Safe;
}
#[doc = "`reset()` method sets 3ICR to value 0"]
impl crate::Resettable for _3ICR_SPEC {}
