#[doc = "Register `5ECCKEYR` writer"]
pub type W = crate::W<_5ECCKEYR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    pub fn ECCKEY(&mut self) -> ECCKEY_W<'_, _5ECCKEYR_SPEC> {
        ECCKEY_W::new(self, 0)
    }
}
#[doc = "RAMCFG memory 5 ECC key register\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`_5ecckeyr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct _5ECCKEYR_SPEC;
impl crate::RegisterSpec for _5ECCKEYR_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`_5ecckeyr::W`](W) writer structure"]
impl crate::Writable for _5ECCKEYR_SPEC {
    type Safety = crate::Safe;
}
#[doc = "`reset()` method sets 5ECCKEYR to value 0"]
impl crate::Resettable for _5ECCKEYR_SPEC {}
