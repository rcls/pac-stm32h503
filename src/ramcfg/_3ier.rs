#[doc = "Register `3IER` reader"]
pub type R = crate::R<_3IER_SPEC>;
#[doc = "Register `3IER` writer"]
pub type W = crate::W<_3IER_SPEC>;
...
impl W {
    #[doc = "Bit 0 - ECC single error interrupt enable"]
    #[inline(always)]
    pub fn SEIE(&mut self) -> SEIE_W<'_, _3IER_SPEC> {
        SEIE_W::new(self, 0)
    }
    #[doc = "Bit 1 - ECC double error interrupt enable"]
    #[inline(always)]
    pub fn DEIE(&mut self) -> DEIE_W<'_, _3IER_SPEC> {
        DEIE_W::new(self, 1)
    }
    #[doc = "Bit 3 - Double error NMI This bit is set by software and cleared only by a global RAMCFG reset. Note: if ECCNMI is set, the RAMCFG maskable interrupt is not generated whatever DEIE bit value."]
    #[inline(always)]
    pub fn ECCNMI(&mut self) -> ECCNMI_W<'_, _3IER_SPEC> {
        ECCNMI_W::new(self, 3)
    }
}
#[doc = "RAMCFG memory 3 interrupt enable register\n\nYou can [`read`](crate::Reg::read) this register and get [`_3ier::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`_3ier::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct _3IER_SPEC;
impl crate::RegisterSpec for _3IER_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`_3ier::R`](R) reader structure"]
impl crate::Readable for _3IER_SPEC {}
#[doc = "`write(|w| ..)` method takes [`_3ier::W`](W) writer structure"]
impl crate::Writable for _3IER_SPEC {
    type Safety = crate::Safe;
}
#[doc = "`reset()` method sets 3IER to value 0"]
impl crate::Resettable for _3IER_SPEC {}
