#[doc = "Register `3ERKEYR` writer"]
pub type W = crate::W<_3ERKEYR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    pub fn ERASEKEY(&mut self) -> ERASEKEY_W<'_, _3ERKEYR_SPEC> {
        ERASEKEY_W::new(self, 0)
    }
}
#[doc = "RAMCFG memory 3 erase key register\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`_3erkeyr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct _3ERKEYR_SPEC;
impl crate::RegisterSpec for _3ERKEYR_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`_3erkeyr::W`](W) writer structure"]
impl crate::Writable for _3ERKEYR_SPEC {
    type Safety = crate::Safe;
}
#[doc = "`reset()` method sets 3ERKEYR to value 0"]
impl crate::Resettable for _3ERKEYR_SPEC {}
