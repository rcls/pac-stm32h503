...
pub type W = crate::W<M4ERKEYR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    pub fn ERASEKEY(&mut self) -> ERASEKEY_W<'_, M4ERKEYR_SPEC> {
...
pub struct M4ERKEYR_SPEC;
impl crate::RegisterSpec for M4ERKEYR_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`m4erkeyr::W`](W) writer structure"]
impl crate::Writable for M4ERKEYR_SPEC {
    type Safety = crate::Safe;
}
#[doc = "`reset()` method sets M4ERKEYR to value 0"]
impl crate::Resettable for M4ERKEYR_SPEC {}
