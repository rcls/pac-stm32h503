#[doc = "Register `3DEAR` reader"]
pub type R = crate::R<_3DEAR_SPEC>;
...
#[doc = "RAMCFG memory 3 ECC double error address register\n\nYou can [`read`](crate::Reg::read) this register and get [`_3dear::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct _3DEAR_SPEC;
impl crate::RegisterSpec for _3DEAR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`_3dear::R`](R) reader structure"]
impl crate::Readable for _3DEAR_SPEC {}
#[doc = "`reset()` method sets 3DEAR to value 0"]
impl crate::Resettable for _3DEAR_SPEC {}
