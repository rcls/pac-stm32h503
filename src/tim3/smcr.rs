...
impl From<SMS_2_A> for bool {
    #[inline(always)]
    fn from(variant: SMS_2_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `SMS_2` reader - Slave mode selection When external signals are selected the active edge of the trigger signal (tim_trgi) is linked to the polarity selected on the external input (see Input Control register and Control Register description. Note: The gated mode must not be used if tim_ti1f_ed is selected as the trigger input (TS=00100). Indeed, tim_ti1f_ed outputs 1 pulse for each transition on tim_ti1f, whereas the gated mode checks the level of the trigger signal. Note: The clock of the slave peripherals (timer, ADC, ...) receiving the tim_trgo signal must be enabled prior to receive events from the master timer, and the clock frequency (prescaler) must not be changed on-the-fly while triggers are received from the master timer."]
pub type SMS_2_R = crate::BitReader<SMS_2_A>;
impl SMS_2_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> SMS_2_A {
        match self.bits {
            false => SMS_2_A::B_0x0,
            true => SMS_2_A::B_0x1,
        }
...
#[doc = "Field `SMS_2` writer - Slave mode selection When external signals are selected the active edge of the trigger signal (tim_trgi) is linked to the polarity selected on the external input (see Input Control register and Control Register description. Note: The gated mode must not be used if tim_ti1f_ed is selected as the trigger input (TS=00100). Indeed, tim_ti1f_ed outputs 1 pulse for each transition on tim_ti1f, whereas the gated mode checks the level of the trigger signal. Note: The clock of the slave peripherals (timer, ADC, ...) receiving the tim_trgo signal must be enabled prior to receive events from the master timer, and the clock frequency (prescaler) must not be changed on-the-fly while triggers are received from the master timer."]
pub type SMS_2_W<'a, REG> = crate::BitWriter<'a, REG, SMS_2_A>;
impl<'a, REG> SMS_2_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Slave mode disabled - if CEN = '1 then the prescaler is clocked directly by the internal clock."]
    #[inline(always)]
    pub fn B_0x0(self) -> &'a mut crate::W<REG> {
        self.variant(SMS_2_A::B_0x0)
    }
    #[doc = "Encoder mode 1 - Counter counts up/down on tim_ti1fp1 edge depending on tim_ti2fp2 level."]
    #[inline(always)]
    pub fn B_0x1(self) -> &'a mut crate::W<REG> {
        self.variant(SMS_2_A::B_0x1)
    }
}
#[doc = "Trigger selection This bit-field selects the trigger input to be used to synchronize the counter. Others: Reserved See for product specific implementation details. Note: These bits must be changed only when they are not used (e.g. when SMS=000) to avoid wrong edge detections at the transition.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
impl From<TS_2_A> for u8 {
    #[inline(always)]
    fn from(variant: TS_2_A) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for TS_2_A {
    type Ux = u8;
}
impl crate::IsEnum for TS_2_A {}
#[doc = "Field `TS_2` reader - Trigger selection This bit-field selects the trigger input to be used to synchronize the counter. Others: Reserved See for product specific implementation details. Note: These bits must be changed only when they are not used (e.g. when SMS=000) to avoid wrong edge detections at the transition."]
pub type TS_2_R = crate::FieldReader<TS_2_A>;
impl TS_2_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> TS_2_A {
        match self.bits {
            0 => TS_2_A::B_0x0,
            1 => TS_2_A::B_0x1,
            2 => TS_2_A::B_0x2,
...
#[doc = "Field `TS_2` writer - Trigger selection This bit-field selects the trigger input to be used to synchronize the counter. Others: Reserved See for product specific implementation details. Note: These bits must be changed only when they are not used (e.g. when SMS=000) to avoid wrong edge detections at the transition."]
pub type TS_2_W<'a, REG> = crate::FieldWriter<'a, REG, 2, TS_2_A, crate::Safe>;
impl<'a, REG> TS_2_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn B_0x0(self) -> &'a mut crate::W<REG> {
        self.variant(TS_2_A::B_0x0)
    }
    #[doc = "Internal trigger 1 (tim_itr1)"]
    #[inline(always)]
    pub fn B_0x1(self) -> &'a mut crate::W<REG> {
        self.variant(TS_2_A::B_0x1)
    }
    #[doc = "Internal trigger 2 (tim_itr2)"]
    #[inline(always)]
    pub fn B_0x2(self) -> &'a mut crate::W<REG> {
        self.variant(TS_2_A::B_0x2)
    }
    #[doc = "Internal trigger 3 (tim_itr3)"]
    #[inline(always)]
    pub fn B_0x3(self) -> &'a mut crate::W<REG> {
        self.variant(TS_2_A::B_0x3)
    }
}
...
impl W {
    ...
    #[doc = "Bit 16 - Slave mode selection When external signals are selected the active edge of the trigger signal (tim_trgi) is linked to the polarity selected on the external input (see Input Control register and Control Register description. Note: The gated mode must not be used if tim_ti1f_ed is selected as the trigger input (TS=00100). Indeed, tim_ti1f_ed outputs 1 pulse for each transition on tim_ti1f, whereas the gated mode checks the level of the trigger signal. Note: The clock of the slave peripherals (timer, ADC, ...) receiving the tim_trgo signal must be enabled prior to receive events from the master timer, and the clock frequency (prescaler) must not be changed on-the-fly while triggers are received from the master timer."]
    #[inline(always)]
    pub fn SMS_2(&mut self) -> SMS_2_W<'_, SMCR_SPEC> {
        SMS_2_W::new(self, 16)
    }
    #[doc = "Bits 20:21 - Trigger selection This bit-field selects the trigger input to be used to synchronize the counter. Others: Reserved See for product specific implementation details. Note: These bits must be changed only when they are not used (e.g. when SMS=000) to avoid wrong edge detections at the transition."]
    #[inline(always)]
    pub fn TS_2(&mut self) -> TS_2_W<'_, SMCR_SPEC> {
        TS_2_W::new(self, 20)
    }
    #[doc = "Bit 24 - SMS preload enable This bit selects whether the SMS\\[3:0\\] bitfield is preloaded"]
    #[inline(always)]
